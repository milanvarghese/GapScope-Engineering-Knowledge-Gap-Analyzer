    ...
    <div className="border border-[var(--amber-dim)] bg-[var(--canvas-2)]">
      ...
      <div className="px-5 py-5 space-y-5">
        ...
        <div className="flex items-center gap-3">
          <span className="font-mono text-[11px] tracking-widest uppercase text-[var(--amber)]">
            Positioning read
          </span>
        ...
        <div className="grid grid-cols-[1fr_auto_1fr] items-center gap-3">
          <div className="border border-[var(--rule-bright)] bg-[var(--canvas-3)] px-4 py-3">
            <div className="font-mono text-[11px] tracking-widest uppercase text-[var(--ink-muted)] mb-1.5">
              Current signal
            </div>
          ...
          <div className="border border-[var(--sage-dim)] bg-[var(--canvas-3)] px-4 py-3">
            <div className="font-mono text-[11px] tracking-widest uppercase text-[var(--sage)] mb-1.5">
              Target signal
            </div>
        ...
        {positioning.moves.length > 0 && (
          <div>
            <div className="font-mono text-[11px] tracking-widest uppercase text-[var(--ink-muted)] mb-3">
              Moves ({positioning.moves.length})
            </div>
            <ol className="space-y-2">
              {positioning.moves.map((move, i) => (
                <li key={i} className="flex gap-3 items-start">
                  <span className="font-mono text-[11px] text-[var(--amber-dim)] w-4 flex-none mt-0.5 leading-tight">
        ...
        {positioning.evidence.length > 0 && (
          <div>
            ...
            >
              <span className="font-mono text-[11px] tracking-widest uppercase text-[var(--ink-muted)] group-hover:text-[var(--ink-dim)] transition-colors duration-150">
                Evidence
              </span>
              ...
              <div className="expand-panel mt-2 space-y-1.5 pl-0">
                {positioning.evidence.map((ev, i) => (
                  <div key={i} className="flex gap-2 items-start">
                    <span className="font-mono text-[var(--ink-muted)] text-[11px] mt-0.5 flex-none">◦</span>
